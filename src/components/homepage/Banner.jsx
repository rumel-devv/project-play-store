...
const Banner = () => {
    return (
        <div className='w-full md:w-10/12 mx-auto h-[106vh] mt-6'>
            <div className='text-center space-y-4'>
                <h2 className='text-3xl md:text-5xl font-bold'> We Build <br /> <span className='text-purple-600'>Productive</span> Apps</h2>
                <p className='w-8/12 mx-auto'>At HERO.IO, we craft innovative apps designed to make everyday life simpler, smarter, and more exciting.Our goal is to turn your ideas into digital experiences that truly make an impact.</p>
